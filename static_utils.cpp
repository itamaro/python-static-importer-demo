...
static PyObject* create_builtin(PyObject* self, PyObject* spec) {
    ...
    return PyImport_CreateBuiltinFromSpecAndInitfunc(spec, initfunc);
}
...
static PyMethodDef static_utils_methods[] = {
    ...
    {"create_builtin", create_builtin, METH_O, check_module_doc},
    {}
};
